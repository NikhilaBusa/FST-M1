...
public class Activity4 {
    ...
    public void contactsTest() {
        ...
        // Enter the details
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='First name']")).sendKeys("Kafka");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='Last name']")).sendKeys("Tamura");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='Phone']")).sendKeys("9837402390");
        // Click Save
        ...
        Assert.assertEquals(contactName, "Kafka Tamura");
    }
